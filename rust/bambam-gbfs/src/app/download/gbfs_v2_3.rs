use gbfs_types::v2_3::files::{GbfsFile, GeofencingZonesFile, SystemInformationFile};
use serde::{Deserialize, Serialize};

#[derive(Serialize, Deserialize, Debug, Clone)]
pub struct GbfsV2_3Import {
...
pub async fn run_v2_3_manifest(
    client: &reqwest::Client,
    url: &str,
) -> Result<Vec<GbfsV2_3Import>, String> {
...
pub async fn run_v2_3_gbfs(client: &reqwest::Client, url: &str) -> Result<GbfsV2_3Import, String> {
    ...
    let result = GbfsV2_3Import { info, geofence };
